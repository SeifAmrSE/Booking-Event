...
import { setCupcakeArrayItems } from "./CupcakeSlice";
...
function CupcakeList() {
  ...
  console.log(cupcakeArrayItems);

  const [orderItem, setOrderItem] = useState([...new Set(cupcakeArrayItems)]);
  ...
  function handleSubmit(e) {
    ...
    dispatch(setCupcakeArrayItems(orderItem));
          ...
          <div className="flex justify-evenly mt-[20px] sm:mt-[30px] sm:text-2xl md:mt-[30px] ">
            <div>
              <input
                ...
                value="Sprinkles"
                onChange={checkItem}
                defaultChecked={cupcakeArrayItems.includes("Sprinkles")}
              />
              ...
              <div className="flex ml-[20px] text-xs mt-[10px] sm:text-base md:text-base xl:text-lg ">
                <div>
                  <input
                    ...
                    onChange={checkItem}
                    defaultChecked={cupcakeArrayItems.includes("Icing Color-Green")}
                  />
                  ...
                  <input
                    ...
                    onChange={checkItem}
                    defaultChecked={cupcakeArrayItems.includes("Icing Color-Red")}
                  />
                  ...
                  <input
                    ...
                    onChange={checkItem}
                    defaultChecked={cupcakeArrayItems.includes("Icing Color-Blue")}
                  />
                  ...
                  <input
                    ...
                    onChange={checkItem}
                    defaultChecked={cupcakeArrayItems.includes("Icing Color-White")}
                  />
                ...
                <div className="sm:ml-[15px]">
                  <input
                    ...
                    onChange={checkItem}
                    defaultChecked={cupcakeArrayItems.includes("Icing Color-Yellow")}
                  />
                  ...
                  <input
                    ...
                    onChange={checkItem}
                    defaultChecked={cupcakeArrayItems.includes("Icing Color-Brown")}
                  />
                  ...
                  <input
                    ...
                    onChange={checkItem}
                    defaultChecked={cupcakeArrayItems.includes("Icing Color-Pink")}
                  />
                  ...
                  <input
                    ...
                    onChange={checkItem}
                    defaultChecked={cupcakeArrayItems.includes("Icing Color-Purple")}
                  />
            ...
            <div>
              <input
                ...
                value="Edible Gold"
                onChange={checkItem}
                defaultChecked={cupcakeArrayItems.includes("Edible Gold")}
              />
