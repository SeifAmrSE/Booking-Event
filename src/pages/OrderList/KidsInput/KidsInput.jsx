...
import { setKidsInputArrayItems } from "./KidsInputSlice";
import { useNavigate } from "react-router-dom";

function KidsInputList() {
  ...
  console.log(kidsInputArrayItems);
  ...
  function handleSubmit(e) {
    ...
    dispatch(setKidsInputArrayItems(names));
